<template>
        ...
        <div class="table-container">
            <el-table ref="roleTable" :data="list" style="width: 100%;" v-loading="listLoading" border>
                ...
                <el-table-column label="操作" width="180" align="center">
                    <template #default="scope">
                        <el-row>
                            <el-button link type="primary" @click="handleSelectMenu(scope.$index, scope.row)">分配菜单
                            </el-button>
                            <el-button link type="primary" @click="handleSelectResource(scope.$index, scope.row)">分配资源
                            </el-button>
                        </el-row>
                        <el-row>
                            ...
                            <el-button link type="primary" @click="handleDelete(scope.$index, scope.row)">删除
                            </el-button>
                        </el-row>
                    </template>
                </el-table-column>
    ...
    <div class="pagination-container">
        <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange"
            ...
            :page-size="listQuery.pageSize" :page-sizes="[5, 10, 15]" :total="parseInt(total)">
        </el-pagination>
    </div>
