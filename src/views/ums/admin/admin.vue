  ...
  <div class="app-container">
    ...
    <div class="pagination-container">
      <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange"
        ...
        v-model:page-size="listQuery.pageSize" :page-sizes="[10, 15, 20]" :total="parseInt(total)">
      </el-pagination>
    </div>
    <el-dialog :title="isEdit ? '编辑用户' : '添加用户'" append-to-body v-model="dialogVisible" width="40%">
    ...
    <el-dialog title="分配角色" v-model="allocDialogVisible" width="30%" append-to-body>
  ...
  methods: {
    ...
    handleAllocDialogConfirm() {
      this.$confirm('是否要确认?', '提示', {
        ...
        // console.log("allocRole params:" + params)
